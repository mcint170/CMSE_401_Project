...
if __name__ == "__main__":
    ...
    torchvision.utils.save_image(images,"./outputs/training_cpu_{}.png".format(batch_size))
    ...
    # Save trained model
    PATH = './outputs/cifar_net_cpu_{}.pth'.format(batch_size)
    ...
    torchvision.utils.save_image(images,"./outputs/testing_cpu_{}.png".format(batch_size)) 
